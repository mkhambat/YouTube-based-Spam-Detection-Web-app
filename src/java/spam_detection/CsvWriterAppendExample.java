...
public class CsvWriterAppendExample {
    ...
    public void writer(CsvWriterAppendExample o) throws FileNotFoundException, IOException {
        String query_vid = null;
        CSVReader reader = new CSVReader(new FileReader("C:\\Users\\Shreeya Jaiswal\\Downloads\\NEW.csv"));
        ...
        if (getVid() != null) {
            if (getVid().equals(query_vid)) {
                String outputFile1 = "C:\\Users\\Shreeya Jaiswal\\Downloads\\reviewentry.csv";
        ...
        if ("eof".equals(getVid())) {
            ...
            String outputFile2 = "C:\\Users\\Shreeya Jaiswal\\Downloads\\NEWentry.csv";
